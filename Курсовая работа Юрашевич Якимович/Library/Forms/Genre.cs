...
namespace Library.Forms
{
...

    {
        ...
        public Genre(Main mainFormP, Panel childPanel)
        {
        ...
        {
            MySqlDataAdapter dataAdapter = new MySqlDataAdapter("SELECT * FROM full.genre;", connection);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if(e.RowIndex >=0)
            {
                ...
                gn_id.Text = row.Cells[0].Value.ToString();
                gn_name.Text = row.Cells[1].Value.ToString();
        ...
        private void Search(DataGridView dataGridView)
        {
            ...
            MySqlDataAdapter dataAdapter = new MySqlDataAdapter($"SELECT * FROM full.genre where concat (gn_id, gn_name) like '%{textBox1.Text}%'; ", connection);
            DataSet dataSet = new DataSet();
            dataAdapter.Fill(dataSet);
        ...
        private void deleteRow() 
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                string sqlCommand = $"DELETE FROM `full`.`genre` WHERE (`gn_id` = '{id}'); ";
