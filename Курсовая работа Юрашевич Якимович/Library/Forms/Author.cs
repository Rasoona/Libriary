...
namespace Library.Forms
{
...

    {
        ...
        public Author(Main mainFormP, Panel childPanel)
        {
        ...
        private void Search(DataGridView dataGridView)
        {
            ...
            MySqlDataAdapter dataAdapter = new MySqlDataAdapter($"SELECT * FROM full.author where concat (au_id, au_pseudonym) like '%{textBox1.Text}%'; ", connection);
            DataSet dataSet = new DataSet();
            dataAdapter.Fill(dataSet);
